...
public class ControladorCompra {
    ...
    private void cargarProveedores() {
        try {
            Type tipoLista = new TypeToken<List<ModeloProveedor>>(){}.getType();
            ...
            // Poblar el ComboBox con los productos (formato: ID_PRODUCTO | NOMBRE_PRODUCTO - TIPO - PRECIO)
    ...
    private void agregarProductoAlCarrito(String seleccion) {
        try {
            ...
            if (productoSeleccionado == null || proveedorSeleccionado == null) return;
    ...
    private void completarCompra() {
        try {
            ...
            for (ItemCompra item : items) {
                ...
                if (productoInventario != null) {
                    ...
                    System.out.println("✓ Nuevo producto agregado al inventario: " + item.getNombreProducto() +
                                     " | Stock inicial: " + item.getCantidad());
                }
            }
            ...
            // Guardar la compra
            Type tipoLista = new TypeToken<List<ModeloCompra>>(){}.getType();
