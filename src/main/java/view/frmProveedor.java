...
public class frmProveedor extends Stage {
    ...
    public frmProveedor(Stage ventanaPadre) {
        ...
        txtBuscar.setPromptText("Buscar proveedores por nombre o ID.");
        txtBuscar.getStyleClass().add("proveedores-buscador");

        VBox buscadorWrapper = new VBox(txtBuscar);
        buscadorWrapper.getStyleClass().add("proveedores-buscador-wrapper");
    ...
    public TextField getTxtProductoId() { return txtProductoId; }
    public TextField getTxtProductoNombre() { return txtProductoNombre; }
    public TextField getTxtProductoTipo() { return txtProductoTipo; }
    public TextField getTxtProductoPrecio() { return txtProductoPrecio; }
    public TableView<String[]> getTablaProveedores() { return tablaProveedores; }
    public TableView<String[]> getTablaProductos() { return tablaProductos; }
    public Button getBtnGuardarProveedor() { return btnGuardarProveedor; }
