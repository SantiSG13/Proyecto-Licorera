...
public class frmInventario extends Stage {
    ...
    public frmInventario(Stage ventanaPadre) {
        ...
        // Buscador
        txtBuscar.setPromptText("Buscar productos por nombre o categoría.");
        txtBuscar.getStyleClass().add("productos-buscador");

        VBox buscadorWrapper = new VBox(txtBuscar);
        buscadorWrapper.getStyleClass().add("productos-buscador-wrapper");
    ...
    private void configurarPanelNuevoProducto() {
        ...
        panelFormulario.getChildren().addAll(tituloNuevoProducto, new Separator(), gridNuevoProducto, botonesNuevoProducto);
